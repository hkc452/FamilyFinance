...
public class Showinfo extends Activity {
    ...
    private int intType=R.id.btnoutinfo;//默认显示支出信息
	@Override
	...
	private void showInfo(int intType) {// 用来根据传入的管理类型，显示相应的信息
		...
		this.intType=intType;//保存intType的值
	...
	@Override
	protected void onRestart() {//重新激活时
		super.onRestart();// 实现基类中的方法
		showInfo(intType);//显示进入item之前的信息
		Log.e("onrestart", strType);
	}
	@Override
	protected void onPause(){
		super.onPause();
		Log.e("hehe", "showpause");
	}
	@Override
